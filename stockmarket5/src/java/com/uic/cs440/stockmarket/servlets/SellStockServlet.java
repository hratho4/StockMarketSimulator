...
public class SellStockServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int sellquantity = Integer.parseInt(request.getParameter("sell_quantity"));
            float price = Float.parseFloat(request.getParameter("price"));
            stock.setStockQuantity(quantity);
            stock.setStockSymbol(request.getParameter("stck"));
            stock.setEmail(player.getEmail());
            stock= SellStockDao.sellStock(stock,sellquantity);
           
            float spentAmt = (float)sellquantity * price;
